...
namespace NinjaTrader.Custom.SuriCommon {
	public static class SuriStrings {
		...
		public static readonly Dictionary<Commodity, CommodityData> data = new Dictionary<Commodity, CommodityData> {
			...
			{Commodity.WheatZw,		new CommodityData(14, "ZW", "", "Weizen ZW")},
			...
			{Commodity.WheatKe,		new CommodityData(15, "KE", "", "Weizen KE")},
...
*/
			...
			{Commodity.BritishPound,		new CommodityData(43, "6B", "", "Pfund")},
			{Commodity.CanadianDollar,		new CommodityData(44, "6C", "", "Kanadischer Dollar")},
			{Commodity.Euro,				new CommodityData(45, "6E", "", "Euro")},
			{Commodity.Yen,					new CommodityData(46, "6J", "", "Yen")},
			{Commodity.BrazilianReal,		new CommodityData(47, "6L", "", "Real")},
			{Commodity.MexicanPeso,			new CommodityData(48, "6M", "", "Peso")},
			{Commodity.NewZealandDollar,	new CommodityData(49, "6N", "", "Neuseeland Dollar")},
			{Commodity.RussianRuble,		new CommodityData(50, "6R", "", "Rubel")},
			{Commodity.SwissFranc,			new CommodityData(51, "6S", "", "Franken")},
