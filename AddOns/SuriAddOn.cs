...
namespace NinjaTrader.Gui.NinjaScript {
	public class SuriAddOn : AddOnBase {
		...
		protected override void OnWindowDestroyed(Window window) {
			ControlCenter cc = window as ControlCenter;
			if (cc == null || StartSuri == null) return;
		...
		private void OnStartSuriClick(object sender, RoutedEventArgs e) {
			Core.Globals.RandomDispatcher.BeginInvoke(new Action(() => new SuriAddOnWindow().Show()));
		}
	...
	public class SuriAddOnWindow : NTWindow, IWorkspacePersistence {
		...
		private void StartEvent(object sender, RoutedEventArgs r) {
